...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2017 at 11:44 AM
...
--
ALTER TABLE `nota_retur_jual`
  ADD CONSTRAINT `fk_returjual_customer` FOREIGN KEY (`id_customer`) REFERENCES `customer` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
