...
<link rel="stylesheet" href="<?php echo asset_url();?>/colorpicker.css" />
<link rel="stylesheet" href="<?php echo asset_url();?>/datepicker.css" />
<link rel="stylesheet" href="<?php echo asset_url();?>/uniform.css" />
<link rel="stylesheet" href="<?php echo asset_url();?>/select2.css" />
<link rel="stylesheet" href="<?php echo asset_url();?>/matrix-style.css" />
<link rel="stylesheet" href="<?php echo asset_url();?>/matrix-media.css" />
<link rel="stylesheet" href="<?php echo asset_url();?>/bootstrap-wysihtml5.css" />
...
<script src="<?php echo asset_url();?>/bootstrap-colorpicker.js"></script> 
<script src="<?php echo asset_url();?>/bootstrap-datepicker.js"></script> 
<script src="<?php echo asset_url();?>/jquery.toggle.buttons.js"></script> 
<script src="<?php echo asset_url();?>/masked.js"></script> 
...
<script src="<?php echo asset_url();?>/matrix.form_common.js"></script> 
<script src="<?php echo asset_url();?>/wysihtml5-0.3.0.js"></script> 
<script src="<?php echo asset_url();?>/jquery.peity.min.js"></script> 
<script src="<?php echo asset_url();?>/bootstrap-wysihtml5.js"></script> 
<script>
