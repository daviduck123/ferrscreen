...
<link rel="stylesheet" href="<?php echo asset_url();?>/bootstrap-responsive.min.css" />
<link rel="stylesheet" href="<?php echo asset_url();?>/fullcalendar.css" />
<link rel="stylesheet" href="<?php echo asset_url();?>/matrix-style.css" />
<link rel="stylesheet" href="<?php echo asset_url();?>/matrix-media.css" />
...
<!--end-Footer-part-->
<script src="<?php echo asset_url();?>/excanvas.min.js"></script> 
<script src="<?php echo asset_url();?>/jquery.min.js"></script> 
<script src="<?php echo asset_url();?>/jquery.ui.custom.js"></script> 
<script src="<?php echo asset_url();?>/bootstrap.min.js"></script> 
<script src="<?php echo asset_url();?>/jquery.flot.min.js"></script> 
<script src="<?php echo asset_url();?>/jquery.flot.resize.min.js"></script> 
<script src="<?php echo asset_url();?>/jquery.peity.min.js"></script> 
<script src="<?php echo asset_url();?>/matrix.js"></script> 
<script src="<?php echo asset_url();?>/fullcalendar.min.js"></script> 
<script src="<?php echo asset_url();?>/matrix.calendar.js"></script> 
<script src="<?php echo asset_url();?>/matrix.chat.js"></script> 
<script src="<?php echo asset_url();?>/jquery.validate.js"></script> 
<script src="<?php echo asset_url();?>/matrix.form_validation.js"></script> 
<script src="<?php echo asset_url();?>/jquery.wizard.js"></script> 
<script src="<?php echo asset_url();?>/jquery.uniform.js"></script> 
<script src="<?php echo asset_url();?>/select2.min.js"></script> 
<script src="<?php echo asset_url();?>/matrix.popover.js"></script> 
<script src="<?php echo asset_url();?>/jquery.dataTables.min.js"></script> 
<script src="<?php echo asset_url();?>/matrix.tables.js"></script> 
<script src="<?php echo asset_url();?>/matrix.interface.js"></script> 
